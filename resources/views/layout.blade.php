...
<body class="home blog halimthemes halimmovies" data-masonry="">
                            ...
                            <div class="form-group form-timkiem">
                                <div class="input-group col-xs-12">
                                    <form action="{{ route('timkiem') }}" method="GET">
                                        ...
                                        <button id="btntimkiem" class="btn btn-warning">Tìm</button>
                                    </form>
                                </div>
                            </div>
                            <ul class="list-group" id="result1" style="display: none">
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <script async defer crossorigin="anonymous"
        src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v15.0&appId=455981356096711&autoLogAppEvents=1"
        nonce="it28E5Yw"></script>
                    ...
                    $.getJSON('/json_file/movies.json', function(data) {
                        $.each(data, function(key, value) {
                            if (value.title.search(expression) != -1) {
                                $('#result1').append(
                                    '<li class="list-group-item" style="cursor:pointer;list-style: none;"><img height="60" width="60" src="/uploads/movie/' +
                                    value.image + '"><span style="font-size:10px">' +
                                    value.title + '.</span><br/></li>');
                            }
                        });
                    })
                } else {
